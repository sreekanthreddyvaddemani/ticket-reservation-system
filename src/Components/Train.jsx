...
// .then((res)=>{
//   localStorage.setItem("buses",JSON.stringify(res.data.data))
//   nav("/filterbuses")
//   toast.success("Data Will Be Available",{
//     position:toast.POSITION.TOP_CENTER
// })
// }).catch(()=>{
//     toast.error("No Route Matched",{
//       position:toast.POSITION.TOP_CENTER
//   })
// })
// }
...
localStorage.setItem("filterTrain",JSON.stringify(data))
nav("/filtertrains")
}
else{
  ...
  return (
    <div>
      <div id="bg">
        <br></br><br/>
        <center>
<h1>TRAIN TICKET BOOKING SITE</h1>
</center>
<form action="">
<div id="div1">
<TextField className='datefield1'  label="FROM" type="text" color="warning" focused placeholder='Enter Place' name={from} onChange={fromData}/>
</div>
<div id="div2">
<TextField className='datefield1'  label="TO" type="text"  color="warning" focused placeholder='Enter Place' name={to} onChange={toData}/>
  </div>
<div id="div3">
<TextField className='datefield' label="SELECT DATE" type="date" color="warning" focused placeholder='Enter Place' name={dop} onChange={dopData}/>
  </div>
<div id="div4">
   <Button variant="contained" color="error" placeholder='MM/DD/YYYY'  disableElevation focused onClick={handleSubmit} >  
      SEARCH TRAINS
    </Button> 
    </div>
</form>
...
<Swiper
  ...
  <div className="data">
    ...
    <button className="b2">FIRST</button>&nbsp;&nbsp;<ContentCopyIcon style={{ color: "white", height:"15px",marginTop:"5px"}}/>
        ...
        <SwiperSlide style={{ height:"180px", width:"290px"}}> <div className="off">
        <div className="off1">
  <div className="one">
  <img src={off1} alt="" />
  </div>
