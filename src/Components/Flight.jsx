  ...
  return (
    <div>
      <div id="bg">
        <br></br><br/>
        <center>
<h1>FLIGHT TICKET BOOKING SITE</h1>
</center>
<form action="">
<div id="div1">
<TextField className='datefield1'  label="FROM" type="text" color="error" focused placeholder='Enter Place' name={from} value={from} onChange={fromData}/>
</div>
<div id="div2">
<TextField className='datefield1'  label="TO" type="text"  color="error" focused placeholder='Enter Place' name={to} value={to} onChange={toData}/>
  </div>
<div id="div3">
<TextField className='datefield' label="SELECT DATE" type="date" color="error" focused  name={dop} value={dop} onChange={dopData}/>
  </div>
<div id="div4">
